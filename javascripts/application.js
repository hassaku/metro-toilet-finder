...
(function() {
  ...
  panelClosure = function() {
    var num, panel;
    num = 0;
    return panel = function(title, content) {
      num++;
      return "<dd class=\"accordion-navigation\">\n  <a href=\"#panel" + num + "\">" + title + "</a>\n    <div id=\"panel" + num + "\" class=\"content\">\n      " + content + "\n    </div>\n  </a>\n</dd>";
    };
  };

  departuresList = function(departures) {
    var departure, list, _i, _len;
    list = "";
